...
public class ListFinishedCourses extends Command {
    private static final long serialVersionUID = 1692298165547157180L;
    private static final Logger LOG = Logger.getLogger(ListFinishedCourses.class);
